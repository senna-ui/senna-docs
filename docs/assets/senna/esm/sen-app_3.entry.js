import { r as registerInstance, h, H as Host, g as getElement, a as getAssetPath } from './index-b3859636.js';
...
const Button = class {
  ...
  render() {
    ...
    return (h(Host, null, h("button", { class: classes, type: this.buttonType, disabled: this.disabled }, h("span", null, this.icon && h("sen-icon", { name: this.icon }), h("slot", null)))));
  }
};
...
export { App as sen_app, Button as sen_button, Icon as sen_icon };
