...
declare global {
    ...
    interface HTMLSennaSearchElement extends Components.SennaSearch, HTMLStencilElement {
    }
    var HTMLSennaSearchElement: {
        prototype: HTMLSennaSearchElement;
        new (): HTMLSennaSearchElement;
    };
    ...
    interface HTMLElementTagNameMap {
        ...
        "senna-search": HTMLSennaSearchElement;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "senna-search": LocalJSX.SennaSearch & JSXBase.HTMLAttributes<HTMLSennaSearchElement>;
